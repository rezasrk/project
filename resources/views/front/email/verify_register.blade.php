                                                                                        ...
                                                                                        <td style="padding:50px 30px 18px 30px; line-height:36px; text-align:inherit; background-color:#ffffff;"
                                                                                            ...
                                                                                            <div>
                                                                                                <div style="font-family: inherit; text-align: center">
                                                                                                    <span style="font-size: 43px">پورتال جامع فلسفه و علوم پایه &nbsp;</span>
                                                                                                </div>
                                                                                                <div></div>
                                                                                            </div>
                                                                                        </td>
                                                                                ...
                                                                                <table class="module" role="module"
                                                                                    ...
                                                                                    <tr>
                                                                                        <td style="padding:18px 30px 18px 30px; line-height:22px; text-align:inherit; background-color:#ffffff;"
                                                                                            ...
                                                                                            <div>
                                                                                                <div style="font-family: inherit; text-align: center">
                                                                                                    <span style="font-size: 18px">از ثبت نام شما متشکریم </span><span
                                                                                                        style="color: #000000; font-size: 18px; font-family: arial,helvetica,sans-serif"> لطفا با کلیک بر روی لینک زیر اکانت خود را فعال نمایید </span><span
                                                                                                        style="font-size: 18px">.</span>
                                                                                                </div>
                                                                                                <div class="">
                                                                                                    <a href="{{ route('verify_email',$token) }}" style="background-color:#ffbe00; border:1px solid #ffbe00; border-color:#ffbe00; border-radius:0px; border-width:1px; color:#000000; display:inline-block; font-size:14px; font-weight:normal; letter-spacing:0px; line-height:normal; padding:12px 40px 12px 40px; text-align:center; text-decoration:none; border-style:solid; font-family:inherit;" target="_blank">تایید ایمیل</a>
                                                                                                </div>
                                                                                                <div style="font-family: inherit; text-align: center">
                                                                                                    <span style="color: #ffbe00; font-size: 18px"><strong></strong></span>
                                                                                                </div>
                                                                                                <div></div>
                                                                                            </div>
                                                                                        </td>
