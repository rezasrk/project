...
Route::get('page/creators','Front\CreatorController@index')->name('front.creator.index');
Route::get('page/creators/{id}','Front\CreatorController@show')->name('front.creator.show');
